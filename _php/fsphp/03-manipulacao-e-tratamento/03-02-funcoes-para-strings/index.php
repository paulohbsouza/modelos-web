...
/**
 * mb_ = multibyte para reconhecer caracteres com acentos como um só
 * caso contrário a função conta como dois caracteres
 */
...
/**
 * Parse para dividir e transforamr em array 
 * (valores parciais da string)
 */
